...
public class PokemonTypeController {
	...
	@PutMapping(path="/{id}")
	public ResponseEntity<PokemonType> replacePokemonType(@RequestBody PokemonType newPokemonType, @PathVariable Integer id) {
		return ResponseEntity.ok(pokemonTypeService.replacePokemonType(newPokemonType, id));
	}
}
