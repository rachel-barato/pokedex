...
public class SpeciesController {
	...
	@PutMapping(path="/{id}")
	public ResponseEntity<Species> replaceSpecies(@RequestBody Species newSpecies, @PathVariable Integer id) {
		return ResponseEntity.ok(speciesService.replaceSpecies(newSpecies, id));
	}
}
